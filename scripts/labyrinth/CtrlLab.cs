...
public class CtrlLab : MonoBehaviour {
    ...
    public Vector3 vectorMovement = Vector3.zero;
    private float floatAnim, capsRad = 0f;

    [HideInInspector]
    public float walkSpd, runSpd;
    ...
    private Vector3 Direccion() {
        ...
        if (move.magnitude > 0) {
            ...
            this.transform.Rotate(0f, move.x * walkSpd, 0f);
            this.transform.Translate(Vector3.forward * (walkSpd * move.z) * Time.deltaTime);
